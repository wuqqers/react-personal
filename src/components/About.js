    ...
    <div className='container mx-auto'>
      <div className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen'>
        ...
        <motion.div
           ...
           viewport={{once: false, amount:0.3}}
        className='flex-1'>
          <h2 className='h2 text-dark'>About me</h2>
           <h3 className='h3 mb-4'>Ben yaklaşık olarak 4 senedir <br/> Front-End  Gelistiricisiyim </h3>
           <p className='mb-6'>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout..
            </p>
            {/* stats */}
       ...
       <button className='btn btn-lg' onClick={goTocontact}>Contact me</button>
